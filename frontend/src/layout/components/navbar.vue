<template>
    <div v-if='getSetting.mode === "vertical" || getMenubar.isPhone'
        ...
        <span class='text-2xl cursor-pointer h-12 leading-12'
        ...
        <el-dropdown>
            ...
            <template #dropdown>
                <el-dropdown-menu>
                    ...
                    <el-dropdown-item>
                        <el-link href='https://github.com/hsiangleev/element-plus-admin' target='_blank'
                            :underline='false'>项目地址</el-link>
                    </el-dropdown-item>
